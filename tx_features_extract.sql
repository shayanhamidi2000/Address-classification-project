...
avg(tx.size) as tx_size_avg, max(tx.size) as tx_size_max, min(tx.size) as tx_size_min,avg(tx.num_of_inp) as tx_num_of_inp_avg,
max(tx.num_of_inp) as tx_num_of_inp_max, min(tx.num_of_inp) as tx_num_of_inp_min,avg(tx.num_of_out) as tx_num_of_out_avg, 
max(tx.num_of_out) as tx_num_of_out_max, min(tx.num_of_out) as tx_num_of_out_min 
